...
| `Adj_FCF_TTM` | `generic_named_range` | `'Valuation'!$D$202` | True |
| `AsOfQuarter` | `formula_dependency` | `'Valuation'!$D$195` | True |
...
| `DCF_EV` | `formula_dependency` | `'Valuation'!$J$222` | True |
| `DCF_FCFF` | `formula_dependency` | `'Valuation'!$J$218` | True |
| `DCF_Growth` | `formula_dependency` | `'Valuation'!$J$219` | True |
| `DCF_Horizon` | `formula_dependency` | `'Valuation'!$D$220` | True |
| `DCF_ImpliedPrice` | `formula_dependency` | `'Valuation'!$J$223` | True |
| `DCF_TerminalGrowth` | `formula_dependency` | `'Valuation'!$J$220` | True |
| `DCF_WACC` | `formula_dependency` | `'Valuation'!$J$221` | True |
...
| `Implied_EV_AdjEBITDA` | `formula_dependency` | `'Valuation'!$N$196` | True |
...
| `NetIncome_TTM` | `formula_dependency` | `'Valuation'!$D$217` | True |
...
| `ScenarioAdjustedMargin` | `formula_dependency` | `'Valuation'!$E$239` | True |
| `ScenarioBaseEBITDA` | `formula_dependency` | `'Valuation'!$E$242` | True |
| `ScenarioBaseMargin` | `formula_dependency` | `'Valuation'!$E$238` | True |
| `ScenarioBuybackCash` | `formula_dependency` | `'Valuation'!$D$253` | True |
| `ScenarioBuybackPrice` | `formula_dependency` | `'Valuation'!$D$254` | True |
| `ScenarioCapexChange` | `formula_dependency` | `'Valuation'!$D$249` | True |
| `ScenarioCashInterestChange` | `formula_dependency` | `'Valuation'!$D$248` | True |
| `ScenarioDebtPaydown` | `formula_dependency` | `'Valuation'!$D$256` | True |
| `ScenarioEPS` | `formula_dependency` | `'Valuation'!$E$261` | True |
| `ScenarioEV` | `formula_dependency` | `'Valuation'!$J$259` | True |
| `ScenarioEVAdjustedEBITDA` | `generic_named_range` | `'Valuation'!$R$261` | True |
| `ScenarioEVBaseEBITDA` | `generic_named_range` | `'Valuation'!$R$260` | True |
| `ScenarioEVRevenue` | `generic_named_range` | `'Valuation'!$R$259` | True |
| `ScenarioEquityValue` | `formula_dependency` | `'Valuation'!$J$260` | True |
| `ScenarioFCF` | `formula_dependency` | `'Valuation'!$E$244` | True |
| `ScenarioFCFYield` | `generic_named_range` | `'Valuation'!$N$261` | True |
| `ScenarioGrowth` | `formula_dependency` | `'Valuation'!$E$237` | True |
| `ScenarioHorizon` | `formula_dependency` | `'Valuation'!$J$236` | True |
| `ScenarioImpliedPrice` | `formula_dependency` | `'Valuation'!$J$261` | True |
| `ScenarioInterestTaxTreatment` | `formula_dependency` | `'Valuation'!$E$248` | True |
| `ScenarioNetDebt` | `formula_dependency` | `'Valuation'!$E$260` | True |
| `ScenarioPE` | `generic_named_range` | `'Valuation'!$N$260` | True |
| `ScenarioPreTaxBridge` | `formula_dependency` | `'Valuation'!$D$247` | True |
| `ScenarioProfile` | `formula_dependency` | `'Valuation'!$E$236` | True |
| `ScenarioRevenue` | `formula_dependency` | `'Valuation'!$E$241` | True |
| `ScenarioShareIssuance` | `formula_dependency` | `'Valuation'!$D$255` | True |
| `ScenarioShares` | `formula_dependency` | `'Valuation'!$E$259` | True |
| `ScenarioTaxRate` | `formula_dependency` | `'Valuation'!$E$240` | True |
| `ScenarioTaxTreatment` | `formula_dependency` | `'Valuation'!$E$247` | True |
| `ScenarioUpside` | `formula_dependency` | `'Valuation'!$N$259` | True |
| `ScenarioWCAdjustment` | `formula_dependency` | `'Valuation'!$D$250` | True |
...
| `Target_EV_Revenue` | `formula_dependency` | `'Valuation'!$D$218` | True |
| `Target_EV_Yield` | `formula_dependency` | `'Valuation'!$D$210` | True |
| `Target_PE` | `formula_dependency` | `'Valuation'!$D$219` | True |
...
| `valuation_input_net_income_ttm` | `active_binding_anchor` | `'Valuation'!$D$217` | True |
