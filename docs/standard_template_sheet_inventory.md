...
| `Valuation_Grid` | `rejected_redundant_sheet` | missing | visible | visible | visible | False | B2 retired the duplicate valuation grid; current scenario and market-implied ownership remains in the canonical Valuation and Investment Case contracts. |
| `Valuation_Summary` | `rejected_redundant_sheet` | missing | visible | visible | visible | False | B2 retired the duplicate valuation-summary engine; canonical valuation and investment-case outputs remain on Valuation and the tokenized Investment Case product. |
