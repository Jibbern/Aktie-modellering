...
| summary_strategic_context_value | SUMMARY | A5:F5 | company_profile.business_description | profile-backed | standard |
| summary_key_advantage_value | SUMMARY | A7:F7 | company_profile.key_advantages | profile-backed | standard |
| summary_revenue_model_values | SUMMARY | A9:F11 | company_profile.revenue_model | profile-backed | standard |
...
| summary_key_financials_values | SUMMARY | B26:B39 | quarterly_financials.rows.0.operating_income, quarterly_financials.rows.0.revenue | source-backed | standard |
| summary_leverage_liquidity_values | SUMMARY | B41:B45 | debt_liquidity.liquidity, debt_liquidity.net_debt | source-backed | standard |
| valuation_actuals_quarterly_values | Valuation | B6:M80 | quarterly_financials.rows.0.adjusted_ebitda, quarterly_financials.rows.0.free_cash_flow, quarterly_financials.rows.0.operating_income, quarterly_financials.rows.0.revenue | source-backed | standard |
| valuation_guidance_values | Valuation | O9:T27 | normalized_guidance.items.0.value | source-backed | standard |
...
| valuation_output_values | Valuation | O64:AA170 | mapping_gaps | derived | standard |
| valuation_guidance_status_values | Valuation | X9:AA27 | normalized_guidance.items.0.horizon | source-backed | standard |
...
| bs_liquidity_values | BS_Segments | B7:I49 | debt_liquidity.cash, debt_liquidity.total_debt | source-backed | standard |
| bs_segment_quarterly_values | BS_Segments | B50:I90 | segments.items.0.revenue | source-backed | standard |
| bs_segment_annual_values | BS_Segments | B91:I120 | segments.items.0.annual_revenue | source-backed | standard |
| od_watchlist_values | Operating_Drivers | B6:N11 | operating_drivers.items.0.current_read | source-backed | standard |
...
| ic_snapshot_values | {ticker}_Investment_Case | B5:K30 | investment_case.summary | manual | standard |
| ic_key_debate_values | {ticker}_Investment_Case | B31:K80 | investment_case.key_debate | manual | standard |
...
| ic_lower_brand_health_values | {ticker}_Investment_Case | B194:K199 | operating_drivers.items.0.current_read | source-backed | standard |
...
| ic_lower_store_productivity_values | {ticker}_Investment_Case | B212:K225 | operating_drivers.items.0.metric_value | source-backed | standard |
...
| qn_quarter_summary_values | Quarter_Notes_UI | B3:O6 | quarter_notes.items.0.note | source-backed | standard |
| qn_quarter_block_values | Quarter_Notes_UI | B8:O360 | quarter_notes.items.0.model_implication, quarter_notes.items.0.note | source-backed | standard |
...
| pp_guidance_timeline_values | Promise_Progress_UI | B61:O69 | normalized_guidance.items.0.horizon | source-backed | standard |
...
| qa_log_rows | QA_Log | A2:Z5000 | manual_review_flags | validation-output | standard |
| needs_review_rows | Needs_Review | A2:Z5000 | manual_review_flags | validation-output | standard |
| qa_checks_rows | QA_Checks | A2:Z5000 | mapping_gaps | validation-output | standard |
...
- `summary_revenue_model_values` `A9:F11`
  - Normalized fields: company_profile.revenue_model
  - Support sheets: Debt_Tranches_Q, History_Q, Leverage_Liquidity, SEC_Audit_Log
  - Current owner: pbi_xbrl/excel_writer_summary_builder.py, pbi_xbrl/excel_writer_summary_sheet.py, pbi_xbrl/summary_overview.py
  - Future owner: future normalized_company_data_builder, docs/workbook_binding_map.json, future value-only filler
...
- `summary_key_financials_values` `B26:B39`
  - Normalized fields: quarterly_financials.rows.0.operating_income, quarterly_financials.rows.0.revenue
  - Support sheets: Debt_Tranches_Q, History_Q, Leverage_Liquidity, SEC_Audit_Log
  - Current owner: pbi_xbrl/excel_writer_summary_builder.py, pbi_xbrl/excel_writer_summary_sheet.py, pbi_xbrl/summary_overview.py
  - Future owner: future normalized_company_data_builder, docs/workbook_binding_map.json, future value-only filler
...
- `summary_leverage_liquidity_values` `B41:B45`
  - Normalized fields: debt_liquidity.liquidity, debt_liquidity.net_debt
  - Support sheets: Debt_Tranches_Q, History_Q, Leverage_Liquidity, SEC_Audit_Log
  - Current owner: pbi_xbrl/excel_writer_summary_builder.py, pbi_xbrl/excel_writer_summary_sheet.py, pbi_xbrl/summary_overview.py
  - Future owner: future normalized_company_data_builder, docs/workbook_binding_map.json, future value-only filler
  - Missing data: blank values; emit mapping gap
...
- `valuation_actuals_quarterly_values` `B6:M80`
  - Normalized fields: quarterly_financials.rows.0.adjusted_ebitda, quarterly_financials.rows.0.free_cash_flow, quarterly_financials.rows.0.operating_income, quarterly_financials.rows.0.revenue
...
- `valuation_output_values` `O64:AA170`
  - Normalized fields: mapping_gaps
  - Support sheets: Debt_Profile, Debt_Tranches_Q, Guidance_Normalized, Hidden_Value_Base, Hidden_Value_Flags, History_Q, Slides_Guidance
  - Current owner: pbi_xbrl/excel_writer_valuation_orchestrator.py, pbi_xbrl/excel_writer_valuation_*, pbi_xbrl/valuation.py
  - Future owner: frozen template shell, docs/workbook_binding_map.json, future value-only filler
...
- `valuation_guidance_status_values` `X9:AA27`
...
- `bs_liquidity_values` `B7:I49`
  - Normalized fields: debt_liquidity.cash, debt_liquidity.total_debt
...
- `bs_segment_quarterly_values` `B50:I90`
  - Normalized fields: segments.items.0.revenue
  - Support sheets: DATA_Facts_Long, Debt_Tranches_Q, History_Q, Slides_Segments
  - Current owner: pbi_xbrl/excel_writer_bs_segments.py, pbi_xbrl/excel_writer_segment_sources.py
  - Future owner: future segments normalizer, docs/workbook_binding_map.json
...
- `bs_segment_annual_values` `B91:I120`
  - Normalized fields: segments.items.0.annual_revenue
  - Support sheets: DATA_Facts_Long, Debt_Tranches_Q, History_Q, Slides_Segments
  - Current owner: pbi_xbrl/excel_writer_bs_segments.py, pbi_xbrl/excel_writer_segment_sources.py
  - Future owner: future segments normalizer, docs/workbook_binding_map.json
...
- `ic_snapshot_values` `B5:K30`
  - Normalized fields: investment_case.summary
...
- `ic_lower_brand_health_values` `B194:K199`
  - Normalized fields: operating_drivers.items.0.current_read
  - Support sheets: Guidance_Normalized, History_Q, Promise_Progress, Quarter_Notes, Scenario_Bridge_Tax_Treatment, Scenario_Driver_Assumptions, Slides_Guidance, Slides_Segments, +1 more
  - Current owner: pbi_xbrl/excel_writer_sector_investment_case.py, pbi_xbrl/excel_writer_investment_case_support.py, pbi_xbrl/excel_writer_anf_investment_case.py
  - Future owner: future investment_case normalizer/review workflow, docs/workbook_binding_map.json
...
- `ic_lower_store_productivity_values` `B212:K225`
  - Normalized fields: operating_drivers.items.0.metric_value
  - Support sheets: Guidance_Normalized, History_Q, Promise_Progress, Quarter_Notes, Scenario_Bridge_Tax_Treatment, Scenario_Driver_Assumptions, Slides_Guidance, Slides_Segments, +1 more
  - Current owner: pbi_xbrl/excel_writer_sector_investment_case.py, pbi_xbrl/excel_writer_investment_case_support.py, pbi_xbrl/excel_writer_anf_investment_case.py
  - Future owner: future investment_case normalizer/review workflow, docs/workbook_binding_map.json
...
- `qn_quarter_summary_values` `B3:O6`
  - Normalized fields: quarter_notes.items.0.note
...
- `qn_quarter_block_values` `B8:O360`
  - Normalized fields: quarter_notes.items.0.model_implication, quarter_notes.items.0.note
  - Support sheets: Guidance_Normalized, Quarter_Narrative_Data, Quarter_Notes, Quarter_Notes_Evidence
  - Current owner: pbi_xbrl/excel_writer_quarter_notes_ui_orchestrator.py, pbi_xbrl/excel_writer_quarter_notes_ui_*, pbi_xbrl/quarter_notes.py
  - Future owner: future quarter_notes normalizer, normalized_company_data_validation.py
  - Missing data: omit quarter block content; emit manual review flag | optional blank with missing_source/manual_review reason
  - Validation: parser_noise_snippet
...
- `pp_guidance_timeline_values` `B61:O69`
  - Normalized fields: normalized_guidance.items.0.horizon
  - Support sheets: Guidance_Normalized, Guidance_Raw, Promise_Evidence, Promise_Progress, Slides_Guidance
  - Current owner: pbi_xbrl/excel_writer_promise_progress.py, pbi_xbrl/excel_writer_promise_progress_*, pbi_xbrl/doc_intel.py
  - Future owner: future normalized_guidance builder, normalized_company_data_validation.py
...
- `qa_log_rows` `A2:Z5000`
  - Normalized fields: manual_review_flags
  ...
  - Missing data: write an empty-pass QA row only after validator returns no issues
  - Validation: normalized_data_issue_shape
...
- `needs_review_rows` `A2:Z5000`
  ...
  - Future owner: pbi_xbrl/normalized_company_data_validation.py, future filler QA writer
  - Missing data: write validation issue rows; do not hide missing fields
  - Validation: normalized_data_issue_shape
...
- `qa_checks_rows` `A2:Z5000`
  ...
  - Missing data: write one check row per binding gap
  - Validation: valuation_core_mapping_gap
