...
_DEFAULT_ECONOMICS_OVERLAY_BRIDGE_ROWS = _overlay_bridge_rows(
    (
        ...
        ("Base business Adj EBITDA ex-credits", "base_business_adj_ebitda_ex_credits", "$m"),
...
COMPANY_PROFILES: Dict[str, CompanyProfile] = {
    "PBI": CompanyProfile(
        ...
        operating_driver_templates=_drivers(
            (
                (
                    "Segment execution",
                    "Presort volumes / margins",
                    "Presort volume, pricing and margin conversion drive turnaround durability.",
                    ("presort", "volume", "mail", "margin"),
                    ("revenue",),
                ),
                (
                    "Segment execution",
                    "SendTech stabilization",
                    "SendTech decline must be controlled for adjusted EBIT and FCF to hold.",
                    ("sendtech", "subscription", "software", "stabilization"),
                    ("revenue", "adj_ebitda", "ebitda"),
                ),
                (
                    "Turnaround / costs",
                    "Cost savings flow-through",
                    "Savings need to convert into adjusted EBIT rather than offset new pressure.",
                    ("cost savings", "productivity", "restructuring", "adjusted ebit"),
                    ("adj_ebit", "adj_ebitda"),
                ),
                (
                    "Cash flow",
                    "FCF conversion",
                    "Free cash flow funds debt reduction and reduces refinancing risk.",
                    ("free cash flow", "fcf", "cash flow", "capex"),
                    ("cash",),
                ),
                (
                    "Capital / financing",
                    "Debt / refinancing",
                    "Leverage, maturities and refinancing shape equity optionality.",
                    ("debt", "refinancing", "maturity", "liquidity", "leverage"),
                    ("debt_core", "cash"),
                ),
            )
        ),
        ...
        enabled_market_sources=("nwer", "ams_3617", "local_chicago_ethanol_futures"),
        ...
        thesis_bridge_labels=(
            "Base Adj EBITDA FY",
            "Presort margin uplift",
            "SendTech stabilization",
            "Pricing / mix uplift",
            "Cost savings uplift",
            "FCF conversion / debt paydown",
    ...
    "ANF": CompanyProfile(
        ...
        segment_patterns=_compile_segments(
            (
                ("Americas", r"\b(americas|north america|south america)\b"),
                ("EMEA", r"\b(emea|europe|middle east|africa)\b"),
                ("APAC", r"\b(apac|asia[- ]pacific|asia pacific|oceania)\b"),
                ("Corporate / Other", r"\b(corporate|reconciling item|unallocated)\b"),
            )
        ),
        segment_alias_patterns=_compile_aliases(
            (
                ...
                (r"\bemea\b", "EMEA"),
                (r"\b(apac|asia[- ]pacific|asia pacific)\b", "APAC"),
                (r"\b(corporate|reconciling item|unallocated)\b", "Corporate / Other"),
            )
        ),
        key_adv_require_keywords=(
            "brand",
        ...
        operating_driver_templates=_drivers(
            (
                (
                    ...
                    "Comparable sales / brand demand",
                    "Comparable sales and brand demand explain revenue growth and inventory turns.",
                    ("comparable sales", "brand", "demand", "customer"),
                    ("revenue",),
                ),
                (
                    "Price / margin",
                    "Gross margin / AUR / markdowns",
                    "Gross margin reflects pricing, markdowns, freight, tariff, and product-cost pressure.",
                    ("gross margin", "average unit retail", "markdown", "freight", "tariff", "raw material"),
                    ("gross_profit", "revenue"),
                ),
                (
                    "Channel / footprint",
                    "Stores / digital / omnichannel",
                    "Store activity and digital execution shape reach, growth, and fixed-cost leverage.",
                    ("store", "digital", "omnichannel", "e-commerce", "remodel", "right-size"),
                    ("revenue",),
                ),
                (
                    "Capital / liquidity",
                    "Buybacks / liquidity",
                    "Cash, liquidity, and repurchases affect per-share value and downside flexibility.",
                    ("share repurchase", "buyback", "liquidity", "cash", "abl facility"),
                    ("cash", "debt_core"),
                ),
            )
        ),
        operating_driver_history_templates=_drivers(
            (
                (
                    "Demand / brand momentum",
                    "Comparable sales",
                    "Comparable sales are the cleanest same-store demand marker for ANF.",
                    ("comparable sales", "comp sales", "comps"),
                    tuple(),
                ...
                (
                    "Demand / brand momentum",
                    "Abercrombie vs Hollister brands",
                    "Brand-family sales mix helps show whether growth is broad-based or concentrated.",
                    ("abercrombie brands", "hollister brands", "brand family"),
                    ("revenue",),
                ...
                (
                    "Margin / costs",
                    "Gross margin / tariff / freight",
                    "Gross margin commentary captures pricing, markdown, tariff, freight, and raw-material pressure.",
                    ("gross margin", "tariff", "freight", "raw material", "markdown"),
                    tuple(),
                    ("gross margin", "tariff", "freight"),
                    "%",
                    "gross_margin_costs",
                ...
                (
                    "Channel / footprint",
                    "Store and digital activity",
                    "Store openings, closures, remodels, and digital investments frame growth investment.",
                    ("store openings", "closures", "remodels", "right-sizes", "digital", "technology"),
                    tuple(),
                    ("stores", "digital"),
                    "",
                    "store_digital_activity",
                ),
                (
                    "Capital / liquidity",
                    "Buybacks / liquidity",
                    "Repurchases and available liquidity are important to per-share outcomes and resilience.",
                    ("share repurchase", "repurchased", "liquidity", "cash", "abl facility"),
                    ("cash", "debt_core"),
                    ("buyback", "liquidity"),
                    "$m",
                    "buybacks_liquidity",
        ...
        official_source_seeds=(
            SourceMaterialSeed(
                ...
                seed_url="https://abercrombieandfitchcompany.gcs-web.com/news-releases",
                follow_detail_pages=True,
                allowed_hosts=("abercrombieandfitchcompany.gcs-web.com",),
            ),
            SourceMaterialSeed(
                family="press_release",
                seed_url="https://corporate.abercrombie.com/investors/news-and-events/news/",
                follow_detail_pages=True,
                allowed_hosts=("corporate.abercrombie.com", "abercrombieandfitchcompany.gcs-web.com"),
            ),
            SourceMaterialSeed(
                family="earnings_presentation",
                seed_url="https://corporate.abercrombie.com/investors/financials-filings/financial-updates/",
                follow_detail_pages=True,
                allowed_hosts=("corporate.abercrombie.com", "abercrombieandfitchcompany.gcs-web.com"),
            ),
            SourceMaterialSeed(
                family="earnings_presentation",
                seed_url="https://abercrombieandfitchcompany.gcs-web.com/financial-information/quarterly-results",
                follow_detail_pages=False,
                allowed_hosts=("abercrombieandfitchcompany.gcs-web.com",),
            ),
            SourceMaterialSeed(
                family="earnings_presentation",
                seed_url="https://abercrombieandfitchcompany.gcs-web.com/events-and-presentations",
                follow_detail_pages=True,
                allowed_hosts=("abercrombieandfitchcompany.gcs-web.com",),
            ),
            SourceMaterialSeed(
                family="earnings_transcripts",
                seed_url="https://corporate.abercrombie.com/investors/news-and-events/events/",
                follow_detail_pages=True,
                allowed_hosts=("corporate.abercrombie.com", "abercrombieandfitchcompany.gcs-web.com"),
            ),
            SourceMaterialSeed(
                family="annual_reports",
                seed_url="https://abercrombieandfitchcompany.gcs-web.com/financial-information/annual-reports",
                follow_detail_pages=False,
                allowed_hosts=("abercrombieandfitchcompany.gcs-web.com",),
            ),
        ),
        source_material_coverage_quarters=20,
        source_material_quarter_alias_mode="retail_fiscal",
        thesis_bridge_labels=(
            "Base Adj EBITDA FY",
            "Net sales / comp uplift",
            "Gross margin uplift",
            "Store and digital investment",
            "Buyback / share-count uplift",
            "Other",
        ),
        summary_description_fallback=(
            "Abercrombie & Fitch Co. is a global, digitally led omnichannel specialty retailer "
            "of apparel and accessories across Abercrombie and Hollister brand families, with "
            "sales through stores, digital channels, and selected third-party arrangements."
        ),
        summary_key_advantage_fallback=(
            "ANF's advantage rests on globally recognized brand families, tight inventory and "
            "merchandising discipline, an omnichannel store and digital model, and a balance "
            "sheet that can fund growth investment while returning capital."
        ),
        summary_segment_operating_model_fallbacks=(
            "Americas: largest geographic segment, including North and South America store and digital demand.",
            "EMEA: Europe, Middle East and Africa operations, with regional store and digital sales.",
            "APAC: Asia-Pacific operations, including Asia and Oceania.",
            "Brand families: Abercrombie brands and Hollister brands provide an additional demand and mix lens.",
        ),
        summary_dependency_fallbacks=(
            "Consumer discretionary demand: apparel spending and brand relevance drive comparable sales.",
            "Gross margin / tariff / freight: product costs, markdowns, freight, and tariffs affect margin conversion.",
            "Inventory execution: trend-right inventory and chase capability reduce markdown and obsolescence risk.",
            "Store and digital investment: openings, remodels, marketing, and technology spending affect growth and operating leverage.",
            "Capital allocation: cash, ABL availability, and buybacks affect per-share value and flexibility.",
        ),
        summary_wrong_thesis_fallbacks=(
            "Brand momentum fades or comparable sales turn negative after recent growth.",
            "Tariffs, freight, raw materials, or markdowns pressure gross margin more than expected.",
        ...
        operating_driver_history_templates=_drivers(
            (
                ...
                (
                    ...
                    "Reported Adjusted EBITDA keeps the company-reported result including any 45Z benefit.",
                    ("adjusted ebitda", "45z", "base business"),
                    tuple(),
                    ("adjusted ebitda",),
                    "$m",
                ...
                (
                    ...
                    "45Z included in Adjusted EBITDA separates the policy-credit component from the reported total.",
                    ("45z", "adjusted ebitda", "base business"),
                    tuple(),
                    ("45z", "adjusted ebitda"),
                    "$m",
                ...
                (
                    ...
                    "Base-business Adjusted EBITDA removes the disclosed 45Z Adjusted EBITDA component.",
                    ("base business", "adjusted ebitda", "45z"),
                    tuple(),
                ...
                (
                    ...
                    "45Z recorded through ethanol-production COGS is the correct component for crush-margin ex-45Z.",
                    ("45z", "cost of goods sold", "crush margin", "ethanol production"),
                    tuple(),
                    ("cost of goods sold", "crush"),
                    "$m",
                    "45z_ethanol_cogs_crush_component",
                ),
                (
                    "Policy / credits",
                    "45Z production tax credits receivable/current asset",
                    "Production tax credits receivable/current asset shows credit value not yet monetized in cash.",
                    ("production tax credits", "balance sheets"),
                    tuple(),
                    ("production tax credits",),
                    "$m",
                    "production_tax_credits_current_asset",
                ),
                (
                    "Policy / credits",
                    "Production tax credits WC increase",
                    "Increase in production tax credits asset explains working-capital drag before cash monetization.",
                    ("production tax credits", "working capital", "balance sheets"),
                    tuple(),
                    ("working capital", "production tax credits"),
                    "$m",
                    "production_tax_credits_working_capital_increase",
                ),
                (
                    "Policy / credits",
                    "45Z accounting treatment / COGS reduction",
                    "ASU 2025-10 disclosure makes clear that 45Z is included in reported gross margin, EBITDA, and crush margin.",
                    ("asu 2025-10", "cost of goods sold", "production tax credits"),
                    tuple(),
                    ("asu 2025-10", "cost of goods sold"),
                    "text",
                    "45z_accounting_treatment_cogs_reduction",
                ),
                (
                    "Policy / credits",
                    "45Z value guided",
