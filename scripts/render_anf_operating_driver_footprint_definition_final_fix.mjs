...
const auditRoot = process.argv[2]
  ?? "C:/Users/Jibbe/Aktier/StockModelData/audit/anf_operating_drivers_footprint_definition_final_fix_2026-08-20";
...
const views = {
  ...
  footprint_definitions: { range: "A53:P61", scale: 1.1 },
};
