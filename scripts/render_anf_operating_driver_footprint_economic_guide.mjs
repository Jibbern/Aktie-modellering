...
const auditRoot = process.argv[2]
  ?? "C:/Users/Jibbe/Aktier/StockModelData/audit/anf_operating_drivers_footprint_economic_guide_2026-08-20";
...
const views = {
  ...
  upper_sheet: { range: "A1:P52", scale: 1.0 },
  footprint_guide: { range: "A53:P61", scale: 1.15 },
};
