...
const auditRoot = process.argv[2]
  ?? "C:/Users/Jibbe/Aktier/StockModelData/audit/anf_operating_drivers_ui_refinement_2026-08-20";
...
const views = {
  full_sheet: { range: "A1:P46", scale: 1.0 },
  overview: { range: "A1:P13", scale: 1.25 },
  core_drivers: { range: "A14:P27", scale: 1.15 },
  quarterly_history: { range: "A28:P46", scale: 1.0 },
};
