...
const auditRoot = process.argv[2]
  ?? "C:/Users/Jibbe/Aktier/StockModelData/audit/operating_drivers_anf_ui_hard_reset_v4_2026-08-18";
...
const views = {
  full_sheet: { range: "A1:O42", scale: 1.0 },
  overview: { range: "A1:O13", scale: 1.25 },
  core_drivers: { range: "A14:O24", scale: 1.15 },
  quarterly_history: { range: "A25:O42", scale: 1.0 },
};
