...
def test_style_contract_schema_palette_and_authoritative_ownership() -> None:
    ...
    assert len(contract["style_disabled"]) == 68
...
def test_anf_style_plan_is_deterministic_and_value_plan_extension_is_additive(
    ...
    assert additive_binding_counts == {
    ...
    focused_pass_b1_business_additions = sum(
    ...
    assert len(value_plan.planned_writes) == 23_613
